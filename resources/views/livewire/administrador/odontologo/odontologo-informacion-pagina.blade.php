        ...
        <div class="contenedor_panel_producto_admin">
            ...
            @if ($direccion)
                <div>
                    ...
                    <a href="{{ route('administrador.odontologo.direccion.editar', $odontologo) }}" target="_blank"
                        class="boton_suelto"><i class="fa-solid fa-pencil"></i> Editar
                        Dirección</a>
                </div>
            @else
                <div>
                    <a href="{{ route('administrador.odontologo.direccion.crear', $odontologo) }}" target="_blank"
        ...
        Livewire.on('eliminarPacienteModal', () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('administrador.odontologo.odontologo-informacion-pagina',
                        'desasignarPaciente');
                    Swal.fire(
                        'Desasignado!',
