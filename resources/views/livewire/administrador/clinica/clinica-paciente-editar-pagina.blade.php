<div>
    ...
    <div class="contenedor_administrador_cabecera">
        ...
        <div class="contenedor_botones_admin">
            <a href="{{ route('administrador.clinica.paciente.todo', ['clinica' => $this->odontologo->id]) }}">
                <i class="fa-solid fa-arrow-left-long"></i> Regresar</a>
            <button wire:click="$emit('eliminarPacienteModal')">
                Eliminar paciente <i class="fa-solid fa-trash-can"></i>
            </button>
            <a href="{{ route('administrador.clinica.paciente.crear', ['clinica' => $this->odontologo->id]) }}">
