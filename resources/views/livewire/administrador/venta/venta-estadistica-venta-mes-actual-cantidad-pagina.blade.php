<div>
    ...
    <div class="contenedor_administrador_cabecera">
        ...
        <div class="contenedor_botones_admin">
            <a href="{{ route('administrador.venta.estadistica.venta.mes.actual.lista') }}">
                Ventas mes actual lista <i class="fa-solid fa-eye"></i></a>
        </div>
    </div>
    ...
    <div class="contenedor_administrador_contenido">
        ...
        <div class="contenedor_panel_producto_admin">
            @if ($cantidad_ventas_mes_actual->count())
                @php
                ...
                <div class="tabla_administrador py-4 overflow-x-auto">
                    <div class="inline-block min-w-full overflow-hidden">
                        <table class="min-w-full leading-normal">
                            ...
                            <tbody>
                                @foreach ($cantidad_ventas_mes_actual as $item)
                                    <tr>
        ...
        <div class="contenedor_panel_producto_admin">
            ...
            @if (count($cantidad_ventas_mes_actual))
                @php
                    foreach ($cantidad_ventas_mes_actual as $item) {
