        ...
        <div class="contenedor_panel_producto_admin formulario">
            <div class="grid_estado_orden">
                ...
                <div class="grid_estado_1 estilo_estado_orden" style="background-color: rgb(245, 171, 11);">
                    <a href="{{ route('odontologo.canjeo.odontologo.index') . '?estado=1' }}">
                        <p class="text-center text-2xl">
                            {{ $pendiente }}
                        </p>
                ...
                <div class="grid_estado_2 estilo_estado_orden" style="background-color: rgb(13, 235, 87);">
                    <a href="{{ route('odontologo.canjeo.odontologo.index') . '?estado=2' }}">
                        <p class="text-center text-2xl">
                            {{ $pagado }}
                        </p>
                ...
                <div class="grid_estado_3 estilo_estado_orden" style="background-color: rgb(243, 57, 10);">
                    <a href="{{ route('odontologo.canjeo.odontologo.index') . '?estado=3' }}">
                        <p class="text-center text-2xl">
                            {{ $anulado }}
                        </p>
                            ...
                            <tbody>
                                @foreach ($canjeos as $ventaItem)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            @if ($ventaItem->estado == 1)
                                                <a style="color: green;"
                                                    href="{{ route('odontologo.canjeo.odontologo.editar', $ventaItem->id) }}">
                                                    <span><i class="fa-solid fa-pencil"></i></span>
                                                </a>
                                            @else
                                                <a style="color: #009eff;"
                                                    href="{{ route('odontologo.canjeo.odontologo.informacion', $ventaItem->id) }}">
