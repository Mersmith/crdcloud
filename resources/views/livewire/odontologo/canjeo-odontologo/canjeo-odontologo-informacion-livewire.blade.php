                ...
                <div class="formulario contenedor_panel_producto_admin">
                    ...
                    <div class="contenedor_1_elementos_100">
                        <div class="contenedor_elemento_item">
                            ...
                            <input type="text" value="{{ $canjeo->descargas_imagen }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="contenedor_1_elementos_100">
                        <div class="contenedor_elemento_item">
                            ...
                            <input type="text" value="{{ $canjeo->descargas_informe }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="contenedor_1_elementos_100">
                        <div class="contenedor_elemento_item">
                            ...
                            <input type="text" value="{{ $canjeo->descargas_link }}" disabled>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach ($canjeo_detalles as $index => $canjeo_detalle)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                {{ $canjeo_detalles[$index]['cantidad'] }}
                                            </td>
                                            <td style="text-align: center;">
                        ...
                        <div class="contenedor_panel_producto_admin">
                            ...
                            <div class="contenedor_1_elementos_imagen">
                                <div class="contenedor_imagenes_subidas_dropzone" id="sortableimagenes">
                                    @foreach ($canjeo->imagenesCanjeo as $key => $imagen)
                                        <div>
                                            <a href="{{ Storage::url($imagen->imagen_canjeo_ruta) }}"
                                                data-lightbox="gallery">
                                                <img src="{{ Storage::url($imagen->imagen_canjeo_ruta) }}"
                                                    alt="">
                                            </a>
                                        </div>
                                    @endforeach
