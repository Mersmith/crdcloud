<div>
    ...
    <div class="contenedor_administrador_cabecera">
        ...
        <div class="contenedor_titulo_admin">
            <h2>Ventas del odontólogo: {{$odontologo->nombre . ' '. $odontologo->apellido }} </h2>
        </div>
    </div>
        ...
        <div class="contenedor_panel_producto_admin formulario">
            <div class="grid_estado_orden">
                ...
                <div class="grid_estado_1 estilo_estado_orden" style="background-color: rgb(245, 171, 11);">
                    <a href="{{ route('encargado.odontologo.sede.venta.todo', $odontologo) . '?estado=1' }}">
                        <p class="text-center text-2xl">
                            {{ $pendiente }}
                        </p>
                ...
                <div class="grid_estado_2 estilo_estado_orden" style="background-color: rgb(13, 235, 87);">
                    <a href="{{ route('encargado.odontologo.sede.venta.todo', $odontologo) . '?estado=2' }}">
                        <p class="text-center text-2xl">
                            {{ $pagado }}
                        </p>
                ...
                <div class="grid_estado_3 estilo_estado_orden" style="background-color: rgb(243, 57, 10);">
                    <a href="{{ route('encargado.odontologo.sede.venta.todo', $odontologo) . '?estado=3' }}">
                        <p class="text-center text-2xl">
                            {{ $anulado }}
                        </p>
