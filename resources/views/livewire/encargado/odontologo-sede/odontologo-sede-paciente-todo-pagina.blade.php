<div>
    ...
    <div class="contenedor_administrador_cabecera">
        ...
        <div class="contenedor_botones_admin">
            ...
            <a href="{{ route('encargado.odontologo.sede.paciente.crear', $odontologo) }}">
                                ...
                                @foreach ($pacientes as $paciente)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a style="color: green;"
                                                href="{{ route('encargado.odontologo.sede.paciente.editar', ['odontologo' => $odontologo->id, 'paciente' => $paciente->id]) }}">
