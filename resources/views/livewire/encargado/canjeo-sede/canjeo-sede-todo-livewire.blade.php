    ...
    <div class="contenedor_administrador_contenido">
        ...
        <div class="contenedor_panel_producto_admin formulario">
            <div class="grid_estado_orden">
                ...
                <div class="grid_estado_1 estilo_estado_orden" style="background-color: rgb(245, 171, 11);">
                    <a href="{{ route('encargado.canjeo.sede.index') . '?estado=1' }}">
                        <p class="text-center text-2xl">
                            {{ $pendiente }}
                        </p>
                ...
                <div class="grid_estado_2 estilo_estado_orden" style="background-color: rgb(13, 235, 87);">
                    <a href="{{ route('encargado.canjeo.sede.index') . '?estado=2' }}">
                        <p class="text-center text-2xl">
                            {{ $pagado }}
                        </p>
                ...
                <div class="grid_estado_3 estilo_estado_orden" style="background-color: rgb(243, 57, 10);">
                    <a href="{{ route('encargado.canjeo.sede.index') . '?estado=3' }}">
                        <p class="text-center text-2xl">
                            {{ $anulado }}
                        </p>
        ...
        <div class="contenedor_panel_producto_admin formulario">
            <div class="contenedor_elemento_item">
                ...
                <input type="text" wire:model="buscarNumeroDeCanjeo"
                    placeholder="Ingrese el número de canjeo u datos del odontológo.">
            </div>
        </div>
