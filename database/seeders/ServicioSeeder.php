...
class ServicioSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        (52, 'TOMO CD + LATERAL S/A', '160.00', '4.80', '160.00'),
        (53, 'TOMO CAMPO MEDIOANO + PANO ', '90.00', '2.70', '90.00'),
        (54, 'RX PANORAMICA CONVENIO ANGELICA GAMARRA', '45.00', '1.35', '0.00'),
        (55, 'TOMOGRAFIA CAMPO MEDIO S/A SOLO CD(INCLUYE 1 RX PANOR&amp;Aacute;MICA EN FISICO) (PROMOCION)', '90.00', '2.70', '90.00'),
        (56, 'TOMO + CEFA C/A ', '190.00', '5.70', '190.00'),
        (57, 'REPETICI&Oacute;N TOMO CAMPO AMPLIO S&Oacute;LO CD', '0.00', '0.00', '0.00'),
        (58, 'TOMOGRAFIA CAMPO MEDIO S/A SOLO CD(INCLUYE 1 RX PANOR&Aacute;MICA EN FISICO) + RX LATERA&Ntilde;', '150.00', '4.50', '150.00'),
        (59, 'TOMO CAMPO AMPLIO Y ORTO 1 VIRTUAL LINEA DE CREDITO', '230.00', '6.90', '0.00'),
        (60, 'ORTO3 (FAMILIAR)', '50.00', '1.50', '0.00'),
        (61, 'TOMO SOLO CD (FAMILIAR)', '50.00', '1.50', '0.00'),
        (62, 'TOMOGRAFIA SOLO CD + PANO VIRTUAL (PROMOCION)', '90.00', '2.70', '0.00'),
        (63, 'REPETICION TOMOGRAFIA SOLO LINK ', '0.00', '0.00', '0.00'),
        (64, 'Tomo CD + Lateral C/A', '180.00', '5.40', '180.00'),
        (65, 'TOMO DE LOCALIZACION', '280.00', '8.40', '0.00'),
        (66, 'TOMO SOLO CD ', '100.00', '3.00', '0.00'),
        (67, 'RX PANORAMICA S/ANALISIS LINEA DE CREDITO KARISMA ANGELICA GAMARRA', '45.00', '2.25', '0.00'),
        (68, 'TOMO SOLO CD+ ORTO 2(PX+LX C/A +FOTOS EXTRAORALES E INTRAORALES,INCLUYE 2 ANALISIS)', '280.00', '14.00', '0.00');";
