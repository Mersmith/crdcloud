...
class PacienteDireccionEditarPagina extends Component
{
    public $paciente;
    ...
    {
        return view('livewire.administrador.paciente.paciente-direccion-editar-pagina')->layout('layouts.administrador.index');
    }
}
