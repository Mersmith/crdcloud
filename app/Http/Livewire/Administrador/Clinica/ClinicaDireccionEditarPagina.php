...
class ClinicaDireccionEditarPagina extends Component
{
    public $clinica;
    ...
    {
        return view('livewire.administrador.clinica.clinica-direccion-editar-pagina')->layout('layouts.administrador.index');
    }
}
