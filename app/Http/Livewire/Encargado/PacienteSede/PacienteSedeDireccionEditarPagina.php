...
class PacienteSedeDireccionEditarPagina extends Component
{
    public $paciente;
    ...
    public function mount(Paciente $paciente)
    {
        ...
        $this->usuario_direccion = $paciente->user->direccion;
    ...
    {
        return view('livewire.encargado.paciente-sede.paciente-sede-direccion-editar-pagina')->layout('layouts.administrador.index');
    }
}
