...
class PacienteSedeClinicaTodoPagina extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.encargado.paciente-sede.paciente-sede-clinica-todo-pagina', compact('odontologos'))->layout('layouts.administrador.index');
    }
}
