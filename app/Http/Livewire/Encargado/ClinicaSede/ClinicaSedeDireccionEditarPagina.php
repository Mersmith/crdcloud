...
class ClinicaSedeDireccionEditarPagina extends Component
{
    public $odontologo;
    ...
    public function mount(Odontologo $clinica)
    {
        ...
        $this->usuario_direccion = $clinica->user->direccion;
    ...
    {
        return view('livewire.encargado.clinica-sede.clinica-sede-direccion-editar-pagina')->layout('layouts.administrador.index');
    }
}
