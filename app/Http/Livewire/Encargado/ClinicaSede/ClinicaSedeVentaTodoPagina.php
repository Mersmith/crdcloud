...
class ClinicaSedeVentaTodoPagina extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.encargado.clinica-sede.clinica-sede-venta-todo-pagina', compact('ventas', 'pendiente', 'pagado', 'anulado', 'todos'))->layout('layouts.administrador.index');
    }
}
