...
class ClinicaSedeEditarPagina extends Component
{
    ...
    public function eliminarClinica()
    {
        ...
        return redirect()->route('encargado.clinica.sede.index');
    }

    public function render()
    {
        return view('livewire.encargado.clinica-sede.clinica-sede-editar-pagina')->layout('layouts.administrador.index');
    }
}
