...
class ClinicaSedeEstadisticaProvinciaListaPagina extends Component
{
    ...
    {
        return view('livewire.encargado.clinica-sede.clinica-sede-estadistica-provincia-lista-pagina')->layout('layouts.administrador.index');
    }
}
