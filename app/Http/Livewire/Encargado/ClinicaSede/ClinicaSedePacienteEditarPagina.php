...
class ClinicaSedePacienteEditarPagina extends Component
{
    ...
    public function eliminarPaciente()
    {
        ...
        return redirect()->route('encargado.clinica.sede.paciente.todo', ['clinica' => $this->odontologo->id]);
    }

    public function render()
    {
        return view('livewire.encargado.clinica-sede.clinica-sede-paciente-editar-pagina')->layout('layouts.administrador.index');
    }
}
