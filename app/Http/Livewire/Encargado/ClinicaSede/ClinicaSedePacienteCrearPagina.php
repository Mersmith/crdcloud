...
class ClinicaSedePacienteCrearPagina extends Component
{
    public $odontologo;
    public $sedes;
    public $sede;
    ...
    public function crearPaciente()
    {
        ...
        return redirect()->route('encargado.clinica.sede.paciente.editar', ['clinica' => $this->odontologo_id, 'paciente' => $usuario->paciente->id]);
    }

    public function render()
    {
        return view('livewire.encargado.clinica-sede.clinica-sede-paciente-crear-pagina')->layout('layouts.administrador.index');
    }
}
