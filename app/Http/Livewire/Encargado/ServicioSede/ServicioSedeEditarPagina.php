...
class ServicioSedeEditarPagina extends Component
{
    ...
    {
        return view('livewire.encargado.servicio-sede.servicio-sede-editar-pagina')->layout('layouts.administrador.index');
    }
}
