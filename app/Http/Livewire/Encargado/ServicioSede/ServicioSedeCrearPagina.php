...
class ServicioSedeCrearPagina extends Component
{
    ...
    {
        return view('livewire.encargado.servicio-sede.servicio-sede-crear-pagina')->layout('layouts.administrador.index');
    }
}
