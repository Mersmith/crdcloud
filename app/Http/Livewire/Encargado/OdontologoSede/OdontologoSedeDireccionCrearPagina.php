...
class OdontologoSedeDireccionCrearPagina extends Component
{
    public $odontologo;
    ...
    public function crearDireccion()
    {
        ...
        $direccion->save();
        return redirect()->route('encargado.odontologo.sede.informacion', $this->odontologo);
    }

    public function render()
    {
        return view('livewire.encargado.odontologo-sede.odontologo-sede-direccion-crear-pagina')->layout('layouts.administrador.index');
    }
}
