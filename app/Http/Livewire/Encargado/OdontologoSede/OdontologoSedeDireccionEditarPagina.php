...
class OdontologoSedeDireccionEditarPagina extends Component
{
    public $odontologo;
    ...
    {
        return view('livewire.encargado.odontologo-sede.odontologo-sede-direccion-editar-pagina')->layout('layouts.administrador.index');
    }
}
