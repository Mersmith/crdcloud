...
class OdontologoSedeEditarPagina extends Component
{
    ...
    public function eliminarOdontologo()
    {
        ...
        return redirect()->route('encargado.odontologo.sede.index');
    }

    public function render()
    {
        return view('livewire.encargado.odontologo-sede.odontologo-sede-editar-pagina')->layout('layouts.administrador.index');
    }
}
