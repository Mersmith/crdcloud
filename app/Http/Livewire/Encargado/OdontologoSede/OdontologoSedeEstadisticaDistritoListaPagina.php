...
class OdontologoSedeEstadisticaDistritoListaPagina extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.encargado.odontologo-sede.odontologo-sede-estadistica-distrito-lista-pagina', compact('odontologos_distritos'))->layout('layouts.administrador.index');
    }
}
