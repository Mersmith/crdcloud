...
class OdontologoSedeCanjeoTodoPagina extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.encargado.odontologo-sede.odontologo-sede-canjeo-todo-pagina', compact('canjeos', 'pendiente', 'pagado', 'anulado', 'todos'))->layout('layouts.administrador.index');
    }
}
