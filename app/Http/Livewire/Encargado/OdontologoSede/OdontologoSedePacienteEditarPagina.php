...
class OdontologoSedePacienteEditarPagina extends Component
{
    ...
    public function eliminarPaciente()
    {
        ...
        return redirect()->route('encargado.odontologo.sede.paciente.todo', $this->odontologo);
    }

    public function render()
    {
        return view('livewire.encargado.odontologo-sede.odontologo-sede-paciente-editar-pagina')->layout('layouts.administrador.index');
    }
}
