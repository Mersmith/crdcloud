...
class OdontologoSedeEstadisticaDepartamentoListaPagina extends Component
{
    ...
    {
        return view('livewire.encargado.odontologo-sede.odontologo-sede-estadistica-departamento-lista-pagina')->layout('layouts.administrador.index');
    }
}
